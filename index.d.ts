...
export type TDSConnection = tds.Connection;
...
export interface config {
  ...
  pool?: PoolOpts<TDSConnection> | undefined;
   ...
   */
  beforeConnect?: ((conn: TDSConnection) => void) | undefined;
}
...
export declare class ConnectionPool extends events.EventEmitter {
  ...
  public readonly pool: Pool<TDSConnection>;
